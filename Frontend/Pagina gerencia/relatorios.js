...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function carregarRelatorios() {
        ...
        try {
            // A URL da API agora busca os relatórios avançados
            ...
            renderizarGraficoProdutos(dados.graficoProdutos); // Renderiza novo gráfico
            renderizarGraficoHorarios(dados.graficoHorariosPico); // Renderiza novo gráfico
